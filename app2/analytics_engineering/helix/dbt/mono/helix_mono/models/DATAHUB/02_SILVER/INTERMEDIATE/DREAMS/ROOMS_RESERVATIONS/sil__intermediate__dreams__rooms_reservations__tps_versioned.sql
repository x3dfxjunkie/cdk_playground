{{
    config(
        ...
        pre_hook = "{{ macro_update_target_version_endtime(
            cleansed_table = ref('sil__intermediate__dreams__rooms_reservations__tps_cleansed'),
            join_columns=['data_tps_id'],
...
with cleansed as (
    select * from {{ ref('sil__intermediate__dreams__rooms_reservations__tps_cleansed') }}
    {% if is_incremental() %}
...
final as (
    select
        ...
        data_trvl_sts_nm,
        data_vip_lvl_nm,
        data_trvl_agcy_pty_id,
        data_trvl_agt_pty_id,
        data_prmy_pty_id,
        data_tps_guar_in,
        data_tps_secur_vl,
        data_tps_ctct_nm,
        data_tps_cncl_dts,
        data_tps_cncl_nb,
        data_tps_cnfm_updt_dts,
        data_tps_cnfrm_usr_id_cd,
        data_tps_ppty_sync_in,
        data_src_acct_ctr_id,
        data_tps_arvl_dt,
        data_tps_dprt_dt,
        data_tps_est_arvl_tm,
        data_tps_est_dprt_tm,
        data_onst_phn_nb,
        data_web_txfr_cd,
        data_dnis_nb,
        data_trms_cndtns_vers_nb,
        data_syw_opt_in,
