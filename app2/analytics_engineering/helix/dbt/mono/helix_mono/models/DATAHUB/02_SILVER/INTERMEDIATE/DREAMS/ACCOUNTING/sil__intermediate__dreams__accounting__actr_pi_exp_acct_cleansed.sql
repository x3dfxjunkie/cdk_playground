{{
    config(
        ...
        unique_key= ['data_acct_ctr_pst_item_exp_acct_id','metadata_checksum'],
...
with source as (
    ...
    from {{ source('brz_dreams_accounting', 'actr_pi_exp_acct') }}
...
renamed as (
    select
        src.data_acct_ctr_pst_item_exp_acct_id as data_acct_ctr_pst_item_exp_acct_id,
        TRIM(src.data_expns_acct_typ_nm) as data_expns_acct_typ_nm,
        ...
        src.data_acct_ctr_pst_item_id as data_acct_ctr_pst_item_id,
    ...
    on src.data_acct_ctr_pst_item_exp_acct_id = min_source_update_datetime.data_acct_ctr_pst_item_exp_acct_id
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_acct_ctr_pst_item_exp_acct_id, metadata_checksum',
