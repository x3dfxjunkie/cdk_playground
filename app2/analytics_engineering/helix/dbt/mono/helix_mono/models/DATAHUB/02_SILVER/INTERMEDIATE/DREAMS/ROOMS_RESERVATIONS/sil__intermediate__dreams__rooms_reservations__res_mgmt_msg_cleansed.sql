...
with source as (
    ...
    from {{ source('brz_dreams_rooms_reservations', 'res_mgmt_msg') }}
...
renamed as (
    select
        ...
        TRIM(src.data_res_mgmt_dlvr_sts_nm) as data_res_mgmt_dlvr_sts_nm,
        src.data_rcpnt_txn_idvl_pty_id as data_rcpnt_txn_idvl_pty_id,
        ...
        {{ macro_generate_checksum([
            ...
            'src.data_jdo_seq_nb',
            'src.data_res_mgmt_dlvr_sts_nm',
            'src.data_rcpnt_txn_idvl_pty_id',
