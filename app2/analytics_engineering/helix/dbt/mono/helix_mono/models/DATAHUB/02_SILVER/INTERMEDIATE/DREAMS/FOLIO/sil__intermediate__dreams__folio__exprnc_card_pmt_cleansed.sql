...
with source as (
    ...
    from {{ source('brz_dreams_folio', 'exprnc_card_pmt') }}
...
renamed as (
    select
        ...
        src.data_gst_cn as data_gst_cn,
        ...
        src.data_crdt_doc_nb as data_crdt_doc_nb,
        TRIM(src.data_ffl_fac_id) as data_ffl_fac_id,
