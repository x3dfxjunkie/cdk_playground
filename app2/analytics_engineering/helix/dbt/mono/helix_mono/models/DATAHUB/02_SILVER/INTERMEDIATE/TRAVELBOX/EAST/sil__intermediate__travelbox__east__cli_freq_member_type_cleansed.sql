...
with source as (
    ...
    from {{ source('brz_travelbox_east', 'cli_freq_member_type') }}
...
renamed as (
    select
        ...
        TRIM(src.data_is_passenger_type) as data_is_passenger_type,
        TRIM(src.data_agency_id) as data_agency_id,
