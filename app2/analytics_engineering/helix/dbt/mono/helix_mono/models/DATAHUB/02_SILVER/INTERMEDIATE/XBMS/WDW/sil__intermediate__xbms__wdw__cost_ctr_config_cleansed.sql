{{
    config(
        ...
        unique_key= ['data_cost_ctr_config_id','metadata_checksum'],
...
with source as (
    ...
    from {{ source('brz_xbms_wdw', 'cost_ctr_config') }}
...
renamed as (
    select
        src.data_cost_ctr_config_id as data_cost_ctr_config_id,
        ...
        TRIM(src.data_ship_insd_fl) as data_ship_insd_fl,
        TRIM(src.data_ship_outsd_fl) as data_ship_outsd_fl,
        ...
        {{ macro_generate_checksum([
            ...
            'src.data_cntry_id',
            'src.data_ship_insd_fl',
            'src.data_ship_outsd_fl',
    ...
    on src.data_cost_ctr_config_id = min_source_update_datetime.data_cost_ctr_config_id
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_cost_ctr_config_id, metadata_checksum',
