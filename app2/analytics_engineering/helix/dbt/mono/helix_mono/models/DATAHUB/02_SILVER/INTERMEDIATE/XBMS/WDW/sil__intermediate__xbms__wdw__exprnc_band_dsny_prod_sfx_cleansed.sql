{{
    config(
        ...
        unique_key= ['data_exprnc_band_dsny_prod_sfx_id','metadata_checksum'],
...
with source as (
    ...
    from {{ source('brz_xbms_wdw', 'exprnc_band_dsny_prod_sfx') }}
...
renamed as (
    select
        ...
        TRIM(src.data_exprnc_band_dsny_prod_sfx_cd) as data_exprnc_band_dsny_prod_sfx_cd,
        TRIM(src.data_avail_in) as data_avail_in,
        ...
        {{ macro_generate_checksum([
            ...
            'src.data_exprnc_band_dsny_prod_sfx_cd',
            'src.data_avail_in',
    ...
    on src.data_exprnc_band_dsny_prod_sfx_id = min_source_update_datetime.data_exprnc_band_dsny_prod_sfx_id
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_exprnc_band_dsny_prod_sfx_id, metadata_checksum',
