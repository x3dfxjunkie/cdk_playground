...
with source as (
    ...
    from {{ source('brz_level_n_wdw', 'rest_req_log') }}
...
renamed as (
    select
        ...
        src.data_req_timestamp_id as data_req_timestamp_id,
    ...
    and src.data_req_timestamp_id = min_source_update_datetime.data_req_timestamp_id
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_correlation_id, data_req_timestamp_id, metadata_checksum',
