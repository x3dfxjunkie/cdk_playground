...
with source as (
    ...
    from {{ source('brz_dreams_resource_inventory_management', 'rsrc_asgn_own_upgr') }}
...
renamed as (
    select
        ...
        TRIM(src.data_upgrd_cmt_tx) as data_upgrd_cmt_tx,
        TRIM(src.data_upgrd_rsn_tx) as data_upgrd_rsn_tx,
        src.data_upgrd_rsrc_invtry_typ_id as data_upgrd_rsrc_invtry_typ_id,
        src.data_upgrd_scr_nb as data_upgrd_scr_nb,
        ...
        {{ macro_generate_checksum([
            ...
            'src.data_upgrd_cmt_tx',
            'src.data_upgrd_rsn_tx',
            'src.data_upgrd_rsrc_invtry_typ_id',
            'src.data_upgrd_scr_nb',
            'src.data_prge_dts',
