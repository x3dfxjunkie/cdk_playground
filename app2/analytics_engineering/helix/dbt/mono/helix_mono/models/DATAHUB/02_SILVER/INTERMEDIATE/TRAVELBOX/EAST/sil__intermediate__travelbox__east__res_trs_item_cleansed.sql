...
with source as (
    ...
    from {{ source('brz_travelbox_east', 'res_trs_item') }}
...
renamed as (
    select
        ...
        src.data_trs_item_no as data_trs_item_no,
        src.data_itinerary_order as data_itinerary_order,
        src.data_embarkation_time as data_embarkation_time,
    ...
    and src.data_trs_item_no = min_source_update_datetime.data_trs_item_no
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_booking_id, data_item_no, data_product_code, data_trs_item_no, metadata_checksum',
