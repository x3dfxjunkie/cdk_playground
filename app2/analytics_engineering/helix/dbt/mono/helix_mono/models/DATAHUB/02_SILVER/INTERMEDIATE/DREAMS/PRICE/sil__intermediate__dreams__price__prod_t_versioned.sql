{{
    config(
        ...
        pre_hook = "{{ macro_update_target_version_endtime(
            cleansed_table = ref('sil__intermediate__dreams__price__prod_t_cleansed'),
            join_columns=['data_prod_id'],
...
with cleansed as (
    select * from {{ ref('sil__intermediate__dreams__price__prod_t_cleansed') }}
    {% if is_incremental() %}
...
versioned as (
    {{ macro_create_versions(
        ...
        partition_columns = ['data_prod_id']
    ) }}
),
...
final as (
    select
        ...
        data_dest,
        data_entrprs_prod_id,
        data_jdo_seq_nb,
        data_max_adv_purch_day_ct,
        data_min_adv_purch_day_ct,
        data_offer_idx_nb,
        data_prge_dts,
        data_prod_bkng_end_dts,
        data_prod_bkng_strt_dts,
        data_prod_cd,
        data_prod_cls_id,
        data_prod_create_dts,
        data_prod_di,
        data_prod_dt_in,
        data_prod_exp_dts,
        data_prod_extnl_nm,
        ...
        data_prod_typ_nm,
        data_prod_updt_dts,
        data_prod_usg_end_dts,
        data_prod_usg_strt_dts,
        data_prod_yr_nb,
        data_sor,
        metadata_checksum,
        metadata_timestamp,
