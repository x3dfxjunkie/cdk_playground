...
with source as (
    ...
    from {{ source('brz_travelbox_west', 'act_cc_card_type') }}
...
renamed as (
    select
        ...
        src.data_merchant_fee as data_merchant_fee,
        src.data_merchant_fee_cust as data_merchant_fee_cust,
        TRIM(src.data_taxable) as data_taxable,
        min_source_update_datetime.min_metadata_timestamp as min_metadata_timestamp,
        {{ macro_generate_checksum([
            'src.data_name',
            'src.data_merchant_fee',
            'src.data_merchant_fee_cust',
            'src.data_taxable',
