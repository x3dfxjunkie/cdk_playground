...
with source as (
    ...
    from {{ source('brz_xbms_wdw', 'exprnc_band_actvy') }}
...
renamed as (
    select
        src.data_exprnc_band_actvy_id as data_exprnc_band_actvy_id,
        ...
        src.data_exprnc_band_updt_dts as data_exprnc_band_updt_dts,
    ...
    on src.data_exprnc_band_actvy_id = min_source_update_datetime.data_exprnc_band_actvy_id
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_exprnc_band_actvy_id, metadata_checksum',
