{{
    config(
        ...
        pre_hook = "{{ macro_update_target_version_endtime(
            cleansed_table = ref('sil__intermediate__travelbox__east__cli_client_cleansed'),
...
with cleansed as (
    select * from {{ ref('sil__intermediate__travelbox__east__cli_client_cleansed') }}
    {% if is_incremental() %}
...
final as (
    select
        ...
        data_client_status,
        data_media,
        data_registered_date,
        data_client_group,
        data_entered_on,
        data_modified_on,
        data_registered_channel,
        data_modified_by,
        data_entered_by,
        data_primary_sales_agent,
        data_status_message,
        data_tax_exempt,
        data_tax_override,
        data_grade_id,
        data_dealing_company,
        data_dealing_division,
        data_currency,
        data_active,
        data_dealing_brand,
        data_locale,
