...
with source as (
    ...
    from {{ source('brz_dreams_accounting', 'sap_dstr_chan') }}
...
renamed as (
    ...
    on src.data_sap_dstr_chan_nm = min_source_update_datetime.data_sap_dstr_chan_nm
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_sap_dstr_chan_nm, metadata_checksum',
