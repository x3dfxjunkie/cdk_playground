{{
    config(
        ...
        unique_key= ['data_txn_pty_rl_id','metadata_checksum'],
...
with source as (
    ...
    from {{ source('brz_dreams_guest', 'txn_pty_rl') }}
...
renamed as (
    select
        ...
        TRIM(src.data_pty_rl_nm) as data_pty_rl_nm,
    ...
    on src.data_txn_pty_rl_id = min_source_update_datetime.data_txn_pty_rl_id
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_txn_pty_rl_id, metadata_checksum',
