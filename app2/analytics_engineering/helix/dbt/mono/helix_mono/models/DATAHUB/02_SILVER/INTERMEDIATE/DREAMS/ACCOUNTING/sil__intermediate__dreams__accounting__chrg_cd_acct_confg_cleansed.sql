{{
    config(
        ...
        unique_key= ['data_chrg_cd_acct_config_id','metadata_checksum'],
...
with source as (
    ...
    from {{ source('brz_dreams_accounting', 'chrg_cd_acct_confg') }}
...
renamed as (
    select
        src.data_chrg_cd_acct_config_id as data_chrg_cd_acct_config_id,
        ...
        src.data_chrg_cd_acct_cfg_strt_dt as data_chrg_cd_acct_cfg_strt_dt,
        src.data_chrg_cd_acct_cfg_end_dt as data_chrg_cd_acct_cfg_end_dt,
        ...
        {{ macro_generate_checksum([
            ...
            'src.data_non_csh_cd',
            'src.data_ord_nb',
            'src.data_chrg_cd_acct_cfg_strt_dt',
            'src.data_chrg_cd_acct_cfg_end_dt',
    ...
    on src.data_chrg_cd_acct_config_id = min_source_update_datetime.data_chrg_cd_acct_config_id
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_chrg_cd_acct_config_id, metadata_checksum',
