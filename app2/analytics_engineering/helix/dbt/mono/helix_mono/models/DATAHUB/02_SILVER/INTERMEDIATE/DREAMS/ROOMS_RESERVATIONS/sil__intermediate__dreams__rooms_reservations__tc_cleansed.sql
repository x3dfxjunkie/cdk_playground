...
with source as (
    ...
    from {{ source('brz_dreams_rooms_reservations', 'tc') }}
...
renamed as (
    select
        ...
        TRIM(src.data_prnt_tc_id) as data_prnt_tc_id,
        TRIM(src.data_upgrd_tc_id) as data_upgrd_tc_id,
        TRIM(src.data_tc_grp_nb) as data_tc_grp_nb,
        ...
        TRIM(src.data_asgn_own_id) as data_asgn_own_id,
        TRIM(src.data_tc_invtry_in) as data_tc_invtry_in,
        TRIM(src.data_srvc_prd_id) as data_srvc_prd_id,
