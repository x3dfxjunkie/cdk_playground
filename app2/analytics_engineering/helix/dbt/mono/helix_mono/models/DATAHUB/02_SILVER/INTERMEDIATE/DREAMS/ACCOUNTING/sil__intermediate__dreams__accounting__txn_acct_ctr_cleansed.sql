...
with source as (
    ...
    from {{ source('brz_dreams_accounting', 'txn_acct_ctr') }}
...
renamed as (
    select
        ...
        TRIM(src.data_prtcpt_in) as data_prtcpt_in,
    ...
    on src.data_txn_acct_ctr_id = min_source_update_datetime.data_txn_acct_ctr_id
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_txn_acct_ctr_id, metadata_checksum',
