...
with source as (
    ...
    from {{ source('brz_dreams_rooms_reservations', 'pkg_tc') }}
...
renamed as (
    select
        ...
        TRIM(src.data_rm_only_pkg_in) as data_rm_only_pkg_in,
        TRIM(src.data_whls_pkg_in) as data_whls_pkg_in,
        ...
        {{ macro_generate_checksum([
            ...
            'src.data_jdo_seq_nb',
            'src.data_rsr_in',
            'src.data_rm_only_pkg_in',
            'src.data_whls_pkg_in',
            'src.data_prge_dts',
