...
with source as (
    ...
    from {{ source('brz_dreams_rooms_reservations', 'grp_tm') }}
...
renamed as (
    select
        src.data_grp_tm_id as data_grp_tm_id,
        TRIM(src.data_grp_cd) as data_grp_cd,
        TRIM(src.data_grp_tm_nm) as data_grp_tm_nm,
    ...
    on src.data_grp_tm_id = min_source_update_datetime.data_grp_tm_id
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_grp_tm_id, metadata_checksum',
