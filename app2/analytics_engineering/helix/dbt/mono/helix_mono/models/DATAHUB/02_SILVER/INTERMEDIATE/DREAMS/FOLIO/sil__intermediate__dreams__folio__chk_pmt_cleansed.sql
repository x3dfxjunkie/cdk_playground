...
with source as (
    ...
    from {{ source('brz_dreams_folio', 'chk_pmt') }}
...
renamed as (
    select
        ...
        TRIM(src.data_chk_orig_nm) as data_chk_orig_nm,
        TRIM(src.data_chk_nb_val) as data_chk_nb_val,
        TRIM(src.data_auth_nb) as data_auth_nb,
        TRIM(src.data_create_usr_id_cd) as data_create_usr_id_cd,
        src.data_create_dts as data_create_dts,
        src.data_prge_dts as data_prge_dts,
        min_source_update_datetime.min_metadata_timestamp as min_metadata_timestamp,
        {{ macro_generate_checksum([
            'src.data_chk_orig_nm',
            'src.data_chk_nb_val',
            'src.data_auth_nb',
