...
with source as (
    ...
    from {{ source('brz_dreams_folio', 'prod_chrg') }}
...
renamed as (
    select
        ...
        src.data_chrg_mkt_pkg_id as data_chrg_mkt_pkg_id,
        TRIM(src.data_comctn_chan_nm) as data_comctn_chan_nm,
        src.data_create_dts as data_create_dts,
        TRIM(src.data_create_usr_id_cd) as data_create_usr_id_cd,
        src.data_jdo_seq_nb as data_jdo_seq_nb,
        TRIM(src.data_ovrd_prod_chrg_in) as data_ovrd_prod_chrg_in,
        src.data_prge_dts as data_prge_dts,
        TRIM(src.data_prod_cd) as data_prod_cd,
        TRIM(src.data_prod_chrg_upgrd_typ_nm) as data_prod_chrg_upgrd_typ_nm,
        TRIM(src.data_prod_ds) as data_prod_ds,
