...
with source as (
    ...
    from {{ source('brz_das_wdw', 'enttl_updt_log') }}
...
renamed as (
    select
        src.data_log_id as data_log_id,
    ...
    on src.data_log_id = min_source_update_datetime.data_log_id
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_log_id, metadata_checksum',
