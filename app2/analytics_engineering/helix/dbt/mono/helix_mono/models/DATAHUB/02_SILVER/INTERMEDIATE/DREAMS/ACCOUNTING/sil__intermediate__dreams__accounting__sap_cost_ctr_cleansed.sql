...
with source as (
    ...
    from {{ source('brz_dreams_accounting', 'sap_cost_ctr') }}
...
renamed as (
    select
        ...
        TRIM(src.data_sap_cost_ctr_nm) as data_sap_cost_ctr_nm,
    ...
    on src.data_sap_cost_ctr_cd = min_source_update_datetime.data_sap_cost_ctr_cd
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_sap_cost_ctr_cd, metadata_checksum',
