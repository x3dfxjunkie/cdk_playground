...
with source as (
    ...
    from {{ source('brz_xbms_wdw', 'exprnc_band_pkg') }}
...
renamed as (
    select
        ...
        TRIM(src.data_pkg_seq_nb) as data_pkg_seq_nb,
    ...
    on src.data_exprnc_band_pkg_id = min_source_update_datetime.data_exprnc_band_pkg_id
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_exprnc_band_pkg_id, metadata_checksum',
