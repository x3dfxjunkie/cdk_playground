...
with source as (
    ...
    from {{ source('brz_dreams_rooms_fulfillment', 'tp') }}
...
renamed as (
    select
        ...
        src.data_tp_strt_dt as data_tp_strt_dt,
        src.data_tp_end_dt as data_tp_end_dt,
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_tp_id, metadata_checksum',
