...
with source as (
    ...
    from {{ source('brz_xbms_wdw', 'exprnc_band_idvl_req') }}
...
renamed as (
    select
        ...
        TRIM(src.data_ship_imdt_req_in) as data_ship_imdt_req_in,
