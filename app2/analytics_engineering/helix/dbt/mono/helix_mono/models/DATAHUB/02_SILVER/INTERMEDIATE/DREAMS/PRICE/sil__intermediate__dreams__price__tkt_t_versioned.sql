{{
    config(
        ...
        pre_hook = "{{ macro_update_target_version_endtime(
            cleansed_table = ref('sil__intermediate__dreams__price__tkt_t_cleansed'),
            join_columns=['data_tkt_id'],
...
with cleansed as (
    select * from {{ ref('sil__intermediate__dreams__price__tkt_t_cleansed') }}
    {% if is_incremental() %}
...
final as (
    select
        ...
        data_age_def_id,
        data_create_dts,
        data_demog_info_rqd_in,
        data_exnl_prc_in,
        data_jdo_seq_nb,
        data_orig_rtl_price_am,
        data_prge_dts,
        data_prod_attr,
        data_tkt_am,
        data_tkt_cd,
        data_tkt_id,
        data_tkt_sls_end_dt,
        data_tkt_sls_strt_dt,
        data_tkt_tax_am,
        data_tkt_usg_end_dt,
        data_tkt_usg_strt_dt,
        data_updt_dts,
        data_vld_dt_meth_nm,
        metadata_checksum,
        metadata_timestamp,
