{{
    config(
        ...
        unique_key= ['data_wrk_loc_id','metadata_checksum'],
...
with source as (
    ...
    from {{ source('brz_dreams_resource_inventory_management', 'wrk_loc') }}
...
renamed as (
    select
        ...
        TRIM(src.data_wrk_loc_nm) as data_wrk_loc_nm,
        ...
        src.data_hm_rsrt_fac_id as data_hm_rsrt_fac_id,
    ...
    on src.data_wrk_loc_id = min_source_update_datetime.data_wrk_loc_id
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_wrk_loc_id, metadata_checksum',
