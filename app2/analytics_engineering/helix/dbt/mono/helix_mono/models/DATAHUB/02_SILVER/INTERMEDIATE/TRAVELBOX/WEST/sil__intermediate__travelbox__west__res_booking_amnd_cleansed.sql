...
with source as (
    ...
    from {{ source('brz_travelbox_west', 'res_booking_amnd') }}
...
renamed as (
    select
        ...
        src.data_amnd_charge as data_amnd_charge,
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_amnd_no, data_booking_id, metadata_checksum',
