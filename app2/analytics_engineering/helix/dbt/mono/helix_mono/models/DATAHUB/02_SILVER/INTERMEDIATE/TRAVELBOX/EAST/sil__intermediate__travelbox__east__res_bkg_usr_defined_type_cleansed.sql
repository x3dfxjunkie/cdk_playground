...
with source as (
    ...
    from {{ source('brz_travelbox_east', 'res_bkg_usr_defined_type') }}
...
renamed as (
    select
        ...
        TRIM(src.data_free_text) as data_free_text,
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_attribute_id, data_booking_id, data_index_no, metadata_checksum',
