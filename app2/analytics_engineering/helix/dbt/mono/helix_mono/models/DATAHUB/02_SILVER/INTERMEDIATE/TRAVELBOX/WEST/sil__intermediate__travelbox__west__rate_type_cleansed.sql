...
with source as (
    ...
    from {{ source('brz_travelbox_west', 'rate_type') }}
...
renamed as (
    select
        ...
        TRIM(src.data_show_markup) as data_show_markup,
        TRIM(src.data_show_commission) as data_show_commission,
        TRIM(src.data_show_nett) as data_show_nett,
        TRIM(src.data_show_gross) as data_show_gross,
        min_source_update_datetime.min_metadata_timestamp as min_metadata_timestamp,
        {{ macro_generate_checksum([
            'src.data_name',
            'src.data_show_markup',
