...
with source as (
    ...
    from {{ source('brz_xbms_wdw', 'dsny_fac_nm') }}
...
renamed as (
    select
        src.data_dsny_fac_nm_id as data_dsny_fac_nm_id,
    ...
    on src.data_dsny_fac_nm_id = min_source_update_datetime.data_dsny_fac_nm_id
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_dsny_fac_nm_id, metadata_checksum',
