...
with source as (
    ...
    from {{ source('brz_dreams_group_management', 'grp_atritn') }}
...
renamed as (
    select
        ...
        src.data_grp_atritn_dy_cn as data_grp_atritn_dy_cn,
        src.data_grp_atritn_dt as data_grp_atritn_dt,
        src.data_grp_atritn_pc as data_grp_atritn_pc,
        TRIM(src.data_grp_atritn_tx) as data_grp_atritn_tx,
        ...
        {{ macro_generate_checksum([
            'src.data_grp_atritn_dy_cn',
            'src.data_grp_atritn_dt',
            'src.data_grp_atritn_pc',
            'src.data_grp_atritn_tx',
            'src.data_create_dts',
