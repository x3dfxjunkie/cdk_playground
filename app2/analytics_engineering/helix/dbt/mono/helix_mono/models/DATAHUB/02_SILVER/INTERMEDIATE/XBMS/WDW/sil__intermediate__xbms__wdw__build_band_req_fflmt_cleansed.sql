...
with source as (
    ...
    from {{ source('brz_xbms_wdw', 'build_band_req_fflmt') }}
...
renamed as (
    select
        src.data_build_band_ord_fflmt_id as data_build_band_ord_fflmt_id,
    ...
    on src.data_build_band_ord_fflmt_id = min_source_update_datetime.data_build_band_ord_fflmt_id
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_build_band_ord_fflmt_id, metadata_checksum',
