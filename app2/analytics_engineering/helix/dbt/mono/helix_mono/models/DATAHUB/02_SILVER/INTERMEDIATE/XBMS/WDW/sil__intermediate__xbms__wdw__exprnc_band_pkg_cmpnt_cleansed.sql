...
with source as (
    ...
    from {{ source('brz_xbms_wdw', 'exprnc_band_pkg_cmpnt') }}
...
renamed as (
    ...
    on src.data_exprnc_band_pkg_cmpnt_id = min_source_update_datetime.data_exprnc_band_pkg_cmpnt_id
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_exprnc_band_pkg_cmpnt_id, metadata_checksum',
