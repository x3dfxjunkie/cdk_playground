{{
    config(
        ...
        unique_key= ['data_tc_grp_nb','metadata_checksum'],
...
with source as (
    ...
    from {{ source('brz_dreams_rooms_reservations', 'tc_grp') }}
...
renamed as (
    select
        ...
        TRIM(src.data_tc_grp_typ_nm) as data_tc_grp_typ_nm,
        TRIM(src.data_adv_internt_chkin_in) as data_adv_internt_chkin_in,
        src.data_add_on_tc_grp_nb as data_add_on_tc_grp_nb,
        ...
        {{ macro_generate_checksum([
            ...
            'src.data_tc_grp_typ_nm',
            'src.data_adv_internt_chkin_in',
            'src.data_add_on_tc_grp_nb',
            'src.data_prge_dts',
    ...
    on src.data_tc_grp_nb = min_source_update_datetime.data_tc_grp_nb
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_tc_grp_nb, metadata_checksum',
