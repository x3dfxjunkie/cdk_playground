...
with source as (
    ...
    from {{ source('brz_dreams_accounting', 'src_acct_ctr') }}
...
renamed as (
    select
        ...
        src.data_dpst_thhld_pc as data_dpst_thhld_pc,
    ...
    on src.data_src_acct_ctr_id = min_source_update_datetime.data_src_acct_ctr_id
),
...
final as (
    {{ dbt_utils.deduplicate(
        relation = 'renamed',
        partition_by = 'data_src_acct_ctr_id, metadata_checksum',
