...
with source as (
    ...
    from {{ source('brz_dreams_resource_inventory_management', 'dsny_ctrl_invtry') }}
...
renamed as (
    select
        ...
        TRIM(src.data_dsny_ctrl_invtry_in) as data_dsny_ctrl_invtry_in,
        min_source_update_datetime.min_metadata_timestamp as min_metadata_timestamp,
        {{ macro_generate_checksum([
            'src.data_dsny_ctrl_invtry_in',
