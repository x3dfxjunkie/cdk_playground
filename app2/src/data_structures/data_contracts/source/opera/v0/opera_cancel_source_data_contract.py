"""Source Data Contract Template for OperaCancelModel"""
...
class OperaBusinessEvent(BaseModel):
    """Class for Business Event Parent payload"""
...
class OperaCancelModel(BaseModel):
    """Payload class for OperaCancelModel"""
