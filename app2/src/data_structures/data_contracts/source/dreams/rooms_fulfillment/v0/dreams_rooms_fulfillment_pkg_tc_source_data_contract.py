...
class Data(GlobalDreamsData, GlobalDreamsTransactCommitTimestamp):
    ...
    rm_only_pkg_in: str = Field(
        ...
        name="Room Only Package Identifyer",
    ...
    whls_pkg_in: str = Field(
        ...,
        alias="WHLS_PKG_IN",
        name="Wholsale Package Identifier",
...
class DREAMSRoomsFulfillmentPkgTcModel(BaseModel):
    """Payload class for DREAMSRoomsFulfillmentPkgTcModel"""
    ...
    class Config:
        ...
        description = "This table provides indicators for Resort Special Reservations, Room only and wholesale packages."  # optional
