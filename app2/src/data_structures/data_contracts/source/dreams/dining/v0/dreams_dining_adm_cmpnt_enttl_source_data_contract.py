...
class Data(GlobalDreamsData):
    ...
    adm_enttl_inactv_dt: Optional[datetime] = Field(
        None,
        alias="ADM_ENTTL_INACTV_DT",
        name="",
        description="",
        example="2013-01-07T18:23:35.302000Z",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class DREAMSDiningAdmCmpntEnttlModel(BaseModel):
    """Payload class for DREAMSDiningAdmCmpntEnttlModel"""
