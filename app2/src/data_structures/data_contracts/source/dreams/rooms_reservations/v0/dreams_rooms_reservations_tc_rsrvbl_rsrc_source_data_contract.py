...
class Data(GlobalDreamsTcId, GlobalDreamsData):
    ...
    tc_rsrc_invtry_id_vl: Optional[int] = Field(
        None,
...
class DREAMSRoomsReservationsTcRsrvblRsrcModel(BaseModel):
    """Payload class for DREAMSRoomsReservationsTcRsrvblRsrcModel"""
