...
class DREAMSRoomsReservationsGrpTcGrpModel(BaseModel):
    """Payload class for DREAMSRoomsReservationsGrpTcGrpModel"""
    ...
    class Config:
        ...
        unique_identifier = ["data.TC_GRP_NB", "data.GRP_CD"]
