...
class Data(GlobalDreamsTpId, GlobalDreamsData):
    ...
    gthr_typ_nm: Optional[str] = Field(
        None,
        alias="GTHR_TYP_NM",
...
class DREAMSRoomsReservationsTpGthrModel(BaseModel):
    """Payload class for DREAMSRoomsReservationsTpGthrModel"""
