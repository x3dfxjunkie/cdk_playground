"""Source Data Contract for Dreams TPS CONFIRM RCPNT"""
...
class Data(GlobalDreamsTpsId, GlobalDreamsData):
    """Class for Dreams TPS CONFIRM RCPNT Data"""
...
class DREAMSRoomsReservationsTpsCnfirmRcpntModel(BaseModel):
    """Payload class for DREAMSRoomsReservationsTpsCnfirmRcpntModel"""
