"""Source Data Contract for DLR EA Lightning Lane"""
...
class ActivityItem(BaseModel):
    ...
    correlation_id: Optional[str] = Field(
        ...
        example="aaaaaaaa-a1b2-4a14-a7a4-1111119de2b9",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
    ...
    redemption_experience_id: Optional[str] = Field(
        ...
        description="The Enterprise/One Source ID for the Experience (Attraction or Show) where redemption occurred",
        example="18375495",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
...
class Entitlement(BaseModel):
    ...
    entitlement_key: str = Field(
        ...
        example="NONINVENTORY-aaaaaaaa-1111-2222-bbbb-111111de3b2a",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class Item(BaseModel):
    ...
    event_id: str = Field(
        ...
        example="111aaa1111aaa11116dbcac12c517513",  # pragma: allowlist secret
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class EADLRLightningLaneModel(BaseModel):
    """Data class that represents the main EA DLR Lightning Lane payload"""

    class Config:
        """Payload level metatags"""

        title = "Experience Accelerator DLR Lightning Lane"
        stream_name = "guest360-dlr-lightning-lane-stream"
        description = "DLR Lightning Lane reservation and redemption data"
    ...
    correlation_id: str = Field(
        ...
        name="Correlation ID",
        description="Internal identifier used for tracking across services",
        example="aaaaaaaa-1111-bbbb-2222-111111f2862a",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
