"""Source Data Contract for GAM DLR Affiliation"""
...
class GAMDLRAffiliationModel(BaseModel):
    """Payload class for GAMDLRAffiliationModel"""

    class Config:
        """Payload Level Metadata"""

        name = "GAM DLR Affiliation"
        stream_name = "gam-kinesis-affil-affiliation-guest360-dlr"
        description = """Affiliations of DLR Guests, as received and derived in GAM"""
