"""Source Data Contract for GAM DLR Guest Identifier Keyring"""
...
class GAMDLRGuestIdentifierModel(BaseModel):
    """Payload class for GAMDLRGuestIdentifierModel"""

    class Config:
        """Payload Level Metadata"""

        name = "GAM DLR Guest Identifier"
        stream_name = "gam-kinesis-gk-guestidentifier-guest360-dlr"
        description = "DLR Guest IDs linked via a common xID in GAM, with visibility to the xIDs"  # optional
        unique_identifier = []
        ...
        key_path_value = "GUEST_IDENTIFIER"  # optional
    ...
    type: str = Field(
        ...
        alias="type",
        name="Event Type",
        description="Represents the GAM event name - always GUEST_IDENTIFIER",
        example="GUEST_IDENTIFIER",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
