"""Source Data Contract for GAM DLR Guest ID Keyring"""
...
class GAMDLRGuestIdModel(BaseModel):
    """Payload class for GAMDLRGuestIdModel"""

    class Config:
        """Payload Level Metadata"""

        title = "GAM DLR Guest ID"
        stream_name = "gam-kinesis-gk-guestid-guest360-dlr"
        description = """DLR Guest IDs linked via a common xID in GAM"""  # optional
        unique_identifier = []
