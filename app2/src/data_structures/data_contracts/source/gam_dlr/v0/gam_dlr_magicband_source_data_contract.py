"""Source Data Contract for GAM DLR XBand"""
...
class Xband(BaseModel):
    ...
    xbandid: str = Field(
        ...
        example="0E45CB0E-FE13-490F-0000-72B30C0B6159",
        guest_identifier=False,
...
class GAMDLRMagicbandModel(BaseModel):
    """Payload class for GAMDLRMagicbandModel"""

    class Config:
        """Payload Level Metatags"""

        title = "GAM DLR MagicBand"
        stream_name = "gam-kinesis-gam-magicband-guest360-dlr"
        description = """DLR Guest magic bands as shared from the magic band management system"""
