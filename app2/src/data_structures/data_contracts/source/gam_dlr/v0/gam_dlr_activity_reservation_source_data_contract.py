"""Source Data Contract for GAM DLR Activity Reservation"""
...
class NativeGuestIdItem(BaseModel):
    """Data class that represents Native Guest Identifier types and values"""
...
class ActivityReservation(BaseModel):
    ...
    activity_reservation_number: str = Field(
        ...,
    ...
    guest_list: Optional[List[NativeGuestIdItem]] = Field(
        None,
        alias="guestList",
        name="Guest List",
        description="Guest list attached to the activity reservation",
    )


class GAMDLRActivityReservationModel(BaseModel):
    """Payload class for GAMDLRActivityReservationModel"""

    class Config:
        """Payload Level Metadata"""

        name = "GAM DLR Activity Reservation"
        stream_name = "gam-kinesis-dreams-activityreservation-guest360-dlr"
        description = "DLR Guest activity reservations as shared by the reservation source system"  # optional
    ...
    action: str = Field(
        ...
        alias="action",
        name="Event Action",
        description="Describes whether the activity reservation was created new, modified or deleted",
        example="MODIFY",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
