"""Source Data Contract Template for GAM DLR Guest Preferences"""
...
class GAMDLRGuestPreferenceModel(BaseModel):
    """Payload class for GAMDLRGuestPreferenceModel"""

    class Config:
        """Payload Level Metadata"""

        title = "GAM DLR Guest Preference"
        stream_name = ""
        description = """DLR Guest preferences associated with Genie"""
        unique_identifier = []
        timezone = "UTC"
        pi_category = [""]
        isps = "Internal Use"
