...
FRE - Free Traveller""",
    ...
    DESCRIPTION: Optional[str] = Field(
        ...
        example="""CM 60 If booked from 06/07/2022 to 31/12/2023, receive 60.00 % discount per night per room. ( Subject to availability )""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class Metadata(BaseModel):
    ...
    timestamp: datetime = Field(
        ...
        example="""2023-08-16 09:43:47.739567""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxWestResAccomDiscountModel(BaseModel):
    """
