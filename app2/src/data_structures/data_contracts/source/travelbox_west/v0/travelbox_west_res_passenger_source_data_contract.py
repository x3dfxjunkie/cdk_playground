...
class Metadata(BaseModel):
    ...
    timestamp: datetime = Field(
        ...
        example="""2023-08-16 09:43:25.961711""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxWestResPassengerModel(BaseModel):
    """
    ...
    class Config:
        ...
        unique_identifier = ["data.BOOKING_ID", "data.PASSENGER_NO"]
        timezone = ""  # optional
