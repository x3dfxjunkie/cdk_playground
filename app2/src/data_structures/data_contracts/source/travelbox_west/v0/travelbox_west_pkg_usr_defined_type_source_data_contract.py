...
class Data(BaseModel):
    ...
    attribute_id: Optional[int] = Field(
        ...
        alias="ATTRIBUTE_ID",
        name="",
        description="Ettribute foreign key",
        example=25,
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    ...
    last_modified_time: datetime = Field(
        ...
        example="2016-05-02T06:29:50.427Z",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
    ...
    date_value: Optional[datetime] = Field(
        ...
        name="",
        description="NA",
        example="2016-05-02T06:52:48.062Z",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class Metadata(BaseModel):
    ...
    timestamp: datetime = Field(
        ...
        example="""2023-08-16 09:47:10.921299""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxWestPkgUsrDefinedTypeModel(BaseModel):
    """
