...
class Data(BaseModel):
    ...
    SYSTEM_DEFINED: Optional[str] = Field(
        ...
        name="",
        description="""Whether this is a user added or system defined voucher type""",
        example="""OEgRUbrRfyzNWHnDDbIb""",
    ...
    EXCLUDE_FROM_NORMAL_SEARCH: Optional[str] = Field(
        ...
        name="",
        description="""True false value : the generic item will not_x000D_
appear on a Component Search  in the Reservation_x000D_
Manager and those generic products will only be available_x000D_
as forced Component in wide search""",
        example="""0""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
...
class Metadata(BaseModel):
    ...
    timestamp: datetime = Field(
        ...
        example="""2023-08-16 09:46:02.105525""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxWestGenProductGroupModel(BaseModel):
    """
