...
class Data(BaseModel):
    ...
    DESCRIPTION: str = Field(
        ...
        example="""If booked from 25/01/2021 to 31/12/2021, get 100 % on Adult, 0 % on Teen, 100 % on Child, 0 % on Infant  discount on price and get 100% Discount (Subject to availability )""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class Metadata(BaseModel):
    ...
    timestamp: datetime = Field(
        ...
        example="""2023-08-16 09:46:47.859654""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxWestResGenericDiscountModel(BaseModel):
    """
    ...
    class Config:
        ...
        unique_identifier = ["data.BOOKING_ID", "data.PRODUCT_CODE", "data.ITEM_NO", "data.DISCOUNT_NO"]
        timezone = ""  # optional
