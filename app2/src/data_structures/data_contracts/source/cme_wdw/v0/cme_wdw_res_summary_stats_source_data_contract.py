"""Source Data Contract for CME WDW Res Summary Stats"""
...
class Data(BaseModel):
    ...
    slot: str = Field(
        ...
        description="Time slot representing reservations summary statistics.  Ex: Daily (full day) or half",
        example="DAILY",
        guest_identifier=False,
        identifier_tag="",
        transaction_identifier=False,
...
class CMEWDWResSummaryStatsModel(BaseModel):
