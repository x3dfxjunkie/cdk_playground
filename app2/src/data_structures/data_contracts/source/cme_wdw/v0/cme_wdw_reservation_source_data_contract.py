"""Source Data Contract for CME WDW Reservation"""
...
class CMEWDWReservationModel(BaseModel):
    """CME WDW Reservation Class"""
    ...
    class Config:
        ...
        description = "Core table representing park reservations at WDW"  # optional
