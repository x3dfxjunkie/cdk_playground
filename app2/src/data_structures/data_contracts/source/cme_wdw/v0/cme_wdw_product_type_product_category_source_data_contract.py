"""Source Data Contract Template for CME WDW Product Category and Product Type"""
...
class CMEWDWProductTypeProductCategoryModel(BaseModel):
    """Payload class for CMEWDWProductTypeProductCategoryModel"""
