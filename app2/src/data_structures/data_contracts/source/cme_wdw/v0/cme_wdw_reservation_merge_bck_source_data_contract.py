"""Source Data Contract Template for CME WDW Reservation Merge Bck"""
...
class CMEWDWReservationMergeBckModel(BaseModel):
    """Payload class for CME WDW Reservation Merge Bck Model"""
