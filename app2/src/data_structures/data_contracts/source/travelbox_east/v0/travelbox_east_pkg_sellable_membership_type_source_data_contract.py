...
class Metadata(BaseModel):
    ...
    timestamp: datetime = Field(
        ...
        example="""2023-08-16 08:53:02.151334""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxEastPkgSellableMembershipTypeModel(BaseModel):
    """
...
sold are stored"""  # optional
        unique_identifier = ["data.PKG_GROUP_ID", "data.MEMBERSHIP_TYPE"]
        timezone = ""  # optional
