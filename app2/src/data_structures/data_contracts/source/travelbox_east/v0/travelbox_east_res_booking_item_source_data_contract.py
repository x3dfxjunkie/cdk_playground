...
Reservation manager > Booking Item Summery > Other Information > Booked as Agent""",
    ...
    contract_ref: Optional[str] = Field(
        ...
        name="",
        description="",
        example="2024_1L_WDTC_WDW_Master_V2",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
If it is a car booking the car name will appear here""",
        example="""Theme Park Tickets-5 Day(Theme Park Ticket with Water Park & Sports Option)""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
overridden commission rate would be used to calculate commission instead of the commision rate.""",
    ...
    PKG_ELEMENT_NAME: Optional[str] = Field(
        ...
        example="""2023_TICKETS_WDTC_PEARL_VARIABLE_515_SNP""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class Metadata(BaseModel):
    ...
    timestamp: datetime = Field(
        ...
        example="""2023-08-16 08:48:58.808429""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxEastResBookingItemModel(BaseModel):
    """
