...
class Data(BaseModel):
    ...
    CODE: str = Field(
        ...
        example="""2016_WDTC_PH_ANNUAL_RD""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
    ...
    NAME: Optional[str] = Field(
        ...
        example="""Annual Passholder Room and Dine""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class Metadata(BaseModel):
    ...
    timestamp: datetime = Field(
        ...
        example="""2023-08-16 08:49:46.388726""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxEastPkgGroupModel(BaseModel):
    """
