...
class Data(BaseModel):
    ...
    APPLICABLE_VALUES: Optional[str] = Field(
        ...
        example="""Disney's Wine & Dine Bottle of Wine Pkg Component (366910)""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class Metadata(BaseModel):
    ...
    timestamp: datetime = Field(
        ...
        example="""2023-08-16 08:51:22.491060""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxEastUdaApplicableValueModel(BaseModel):
    """
