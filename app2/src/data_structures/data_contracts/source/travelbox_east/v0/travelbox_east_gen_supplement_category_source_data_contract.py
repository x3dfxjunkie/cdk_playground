...
class Data(BaseModel):
    ...
    NAME: Optional[str] = Field(
        ...
        example="""2 Quick Service Meals - RS""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
    ...
    DESCRIPTION: Optional[str] = Field(
        ...
        example="""Two Quick Service Meals""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class Metadata(BaseModel):
    ...
    timestamp: datetime = Field(
        ...
        example="""2023-08-16 08:52:19.792976""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxEastGenSupplementCategoryModel(BaseModel):
    """
