...
class Data(BaseModel):
 ...
 - TravelBox agent : false""",
    ...
    SELF_BILLING: str = Field(
        ...
        alias="SELF_BILLING",
        name="",
        description="""Flag to indicate by whom the tax on commission is handled._x000D_1 - by the tour operator_x000D_0 - by the client """,
        example="""0""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
...
class Metadata(BaseModel):
    ...
    timestamp: datetime = Field(
        ...
        example="""2023-08-16 08:51:29.939829""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxEastCliTradeClientModel(BaseModel):
    """
