...
class Data(BaseModel):
    ...
    DESCRIPTION: Optional[str] = Field(
        ...
        example="""Margaritaville Supplier Cancellation """,
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class Metadata(BaseModel):
    ...
    timestamp: datetime = Field(
        ...
        example="""2023-08-16 08:48:51.253041""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxEastCancellationSchemeModel(BaseModel):
    """
