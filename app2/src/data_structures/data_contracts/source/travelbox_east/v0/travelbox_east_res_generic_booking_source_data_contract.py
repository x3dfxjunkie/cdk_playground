...
Hours = 'H'""",
    ...
    PRODUCT_GROUP_NAME: Optional[str] = Field(
        ...
        example="""WDTC Magical Extras - WWS""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
    ...
    PRODUCT_TYPE_NAME: Optional[str] = Field(
        ...
        example="""WDTC Magical Extras -EWWS""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class Metadata(BaseModel):
    ...
    timestamp: datetime = Field(
        ...
        example="""2023-08-16 08:51:51.101124""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxEastResGenericBookingModel(BaseModel):
    """
