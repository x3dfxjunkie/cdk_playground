...
class Metadata(BaseModel):
    ...
    timestamp: datetime = Field(
        ...
        example="""2023-08-16 08:48:14.521188""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxEastResBookingAmndModel(BaseModel):
    """
