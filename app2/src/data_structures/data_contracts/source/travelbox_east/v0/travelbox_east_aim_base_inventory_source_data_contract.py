...
class Data(BaseModel):
    ...
    last_modified: datetime = Field(
        ...
        example="2023-06-01T02:30:15.000Z",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
    ...
    man_adj_date: Optional[datetime] = Field(
        ...
        name="",
        description="NA",
        example="2023-05-09 00:00:00.000",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxEastAimBaseInventoryModel(BaseModel):
    """
    ...
    class Config:
        ...
        description = "Base Inventory table"  # optional
