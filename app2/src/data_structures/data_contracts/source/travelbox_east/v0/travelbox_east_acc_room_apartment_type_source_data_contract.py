...
class Data(BaseModel):
    ...
    SYS_GENERATED: Optional[str] = Field(
        ...
        alias="SYS_GENERATED",
        name="",
        description="""System genereated room type - 1, User created room type - 0""",
        example="""1""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    ...
    NAME: str = Field(
        ...
        example="""StdRm WChrAcc RollIn OptHr K""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class Metadata(BaseModel):
    ...
    timestamp: datetime = Field(
        ...
        example="""2023-08-16 08:48:04.227034""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxEastAccRoomApartmentTypeModel(BaseModel):
    """
