...
class Data(BaseModel):
    ...
    PICKUP_POINT: str = Field(
        ...
        example="""Honolulu International Apt , Honolulu , United States of America""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
    ...
    DROPOFF_POINT: str = Field(
        ...
        example="""Aulani a Disney Resort and Spa , Ko Olina , United States of America""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
    ...
    TRANSFER_NAME: Optional[str] = Field(
        ...
        example="""H - 2023 HI Hele Hele Shared Shuttle""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class Metadata(BaseModel):
    ...
    timestamp: datetime = Field(
        ...
        example="""2023-08-16 08:47:58.670096""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxEastResTrsExcBookingItemModel(BaseModel):
    """
