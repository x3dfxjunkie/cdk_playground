...
3 = TYPE3 ((GET % OR AMOUNT IN DISCOUNT  BASED ON BOOKING TO DEPARTURE DURATION)""",
    ...
    ASSOCIATE_SESSION_ID: Optional[str] = Field(
        ...
        name="",
        description="""NaN""",
        example="""999b26a6-446a-4129-9ee4-766367a81376""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
    ...
    PACKAGE_NAME: Optional[str] = Field(
        ...
        example="""648 2022 WDTC IOTA Variable Tickets""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class Metadata(BaseModel):
    ...
    timestamp: datetime = Field(
        ...
        example="""2023-08-16 08:53:03.812621""",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxEastResBookingPackageModel(BaseModel):
    """
