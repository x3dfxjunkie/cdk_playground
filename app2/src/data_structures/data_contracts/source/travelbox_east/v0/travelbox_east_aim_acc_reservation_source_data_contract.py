...
class Data(BaseModel):
    ...
    last_modified_time: datetime = Field(
        ...
        example="2020-04-28T23:15:03.000Z",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
    ...
    service_date: Optional[datetime] = Field(
        ...
        example="2020-06-15T06:30:00.000Z",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
    ...
    package_code: Optional[str] = Field(
        ...
        name="NA",
        description="NA",
        example="2020_WDTC_ORL_RTD_ANNUAL_V4_GAMMA_966",
        guest_identifier=False,
        transaction_identifier=False,
        identifier_tag="",
    )
...
class TravelBoxEastAimAccReservationModel(BaseModel):
    """
