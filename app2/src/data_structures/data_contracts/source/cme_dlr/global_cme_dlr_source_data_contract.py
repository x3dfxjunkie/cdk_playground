...
class GlobalCMEDLRSchemaName(Enum):
    """Global CME schema name"""

    AWAKENING = "awakening"


class GlobalCMEDLRTableName(Enum):
...
class GlobalCMEDLRMetadata(BaseModel):
    ...
    operation: GlobalCMEDLROperation = Field(
        ...,
        alias="operation",
        name="Operation",
    ...
    schema_name: GlobalCMEDLRSchemaName = Field(
        ...,
        alias="schema-name",
        name="Schema Name",
    ...
    table_name: GlobalCMEDLRTableName = Field(
        ...,
        alias="table-name",
        name="Table Name",
