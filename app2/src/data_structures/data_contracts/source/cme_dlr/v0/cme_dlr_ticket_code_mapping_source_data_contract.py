"""Source Data Contract Template for CME DLR Ticket Code Mapping"""
...
class CMEDLRTicketCodeMappingModel(BaseModel):
    """Payload class for CME DLR Ticket Code Mapping Model"""
