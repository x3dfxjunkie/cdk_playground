"""Source Data Contract for GAM WDW Planning Party"""
...
class GAMWDWPlanningPartyModel(BaseModel):
    """Payload class for GAMWDWPlanningPartyModel"""

    class Config:
        """Payload Level Metadata"""

        name = "GAM WDW Planning Party"
        stream_name = "gam-kinesis-gam-planningparty-guest360-wdw"
        description = """WDW Guests that are tied under planning parties via MDX"""
